...
// Accepte soit la clé super admin (page web) soit un JWT avec role='superadmin' (app mobile)
const authenticateSuperAdmin = async (req, res, next) => {
  // Méthode 1: Clé super admin (page web)
  ...
  // Méthode 2: JWT avec role='superadmin' (app mobile)
  try {
    const authHeader = req.headers.authorization;
    if (!authHeader || !authHeader.startsWith("Bearer ")) {
